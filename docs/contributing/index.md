...
-   Posting content that is illegal to publish or illegal to distribute without permission in Germany. The reason is that in certain cases, especially when it comes to copyright, the service provider (who might be Fosscord founders), may be held liable, and we do not wish to get into legal trouble.
...
If a moderator violates the code of conduct, make sure to point it out to maintainers. This can lead to warnings and demotion of the moderator.
